...
namespace OMGITWebServices
{
    ...
    public partial class OMGLoginData : object
    {
        ...
        private string ExpansionStringField;
        ...
        public string ExpansionString
        {
            get
            {
                return this.ExpansionStringField;
            }
            set
            {
                this.ExpansionStringField = value;
            }
        }
...
public interface IOMGITService
{
    ...
    System.IAsyncResult BeginRegisterForNotifications(OMGITWebServices.OMGInstallationData name, OMGITWebServices.OMGLoginData loginData, System.AsyncCallback callback, object asyncState);
    ...
    [System.ServiceModel.OperationContractAttribute(AsyncPattern=true, Action="http://tempuri.org/IOMGITService/AddLogMessageMobile", ReplyAction="http://tempuri.org/IOMGITService/AddLogMessageMobileResponse")]
    System.IAsyncResult BeginAddLogMessageMobile(string logmessage, string stringparam, int intparam, OMGITWebServices.OMGLoginData loginData, System.AsyncCallback callback, object asyncState);
    
    void EndAddLogMessageMobile(System.IAsyncResult result);
...
public partial class OMGITServiceClient : System.ServiceModel.ClientBase<IOMGITService>, IOMGITService
{
    ...
    private BeginOperationDelegate onBeginAddLogMessageMobileDelegate;
    
    private EndOperationDelegate onEndAddLogMessageMobileDelegate;
    
    private System.Threading.SendOrPostCallback onAddLogMessageMobileCompletedDelegate;
    ...
    public event System.EventHandler<System.ComponentModel.AsyncCompletedEventArgs> AddLogMessageMobileCompleted;
    ...
    [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
    System.IAsyncResult IOMGITService.BeginRegisterForNotifications(OMGITWebServices.OMGInstallationData name, OMGITWebServices.OMGLoginData loginData, System.AsyncCallback callback, object asyncState)
    {
        return base.Channel.BeginRegisterForNotifications(name, loginData, callback, asyncState);
    }
    ...
    private System.IAsyncResult OnBeginRegisterForNotifications(object[] inValues, System.AsyncCallback callback, object asyncState)
    {
        ...
        return ((IOMGITService)(this)).BeginRegisterForNotifications(name, loginData, callback, asyncState);
    }
    ...
    public void RegisterForNotificationsAsync(OMGITWebServices.OMGInstallationData name, OMGITWebServices.OMGLoginData loginData)
    {
        this.RegisterForNotificationsAsync(name, loginData, null);
    }
    
    public void RegisterForNotificationsAsync(OMGITWebServices.OMGInstallationData name, OMGITWebServices.OMGLoginData loginData, object userState)
    {
        ...
        base.InvokeAsync(this.onBeginRegisterForNotificationsDelegate, new object[] {
                    name,
                    loginData}, this.onEndRegisterForNotificationsDelegate, this.onRegisterForNotificationsCompletedDelegate, userState);
    }
    ...
    [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
    System.IAsyncResult IOMGITService.BeginAddLogMessageMobile(string logmessage, string stringparam, int intparam, OMGITWebServices.OMGLoginData loginData, System.AsyncCallback callback, object asyncState)
    {
        return base.Channel.BeginAddLogMessageMobile(logmessage, stringparam, intparam, loginData, callback, asyncState);
    }
    
    [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
    void IOMGITService.EndAddLogMessageMobile(System.IAsyncResult result)
    {
        base.Channel.EndAddLogMessageMobile(result);
    }
    
    private System.IAsyncResult OnBeginAddLogMessageMobile(object[] inValues, System.AsyncCallback callback, object asyncState)
    {
        string logmessage = ((string)(inValues[0]));
        string stringparam = ((string)(inValues[1]));
        int intparam = ((int)(inValues[2]));
        OMGITWebServices.OMGLoginData loginData = ((OMGITWebServices.OMGLoginData)(inValues[3]));
        return ((IOMGITService)(this)).BeginAddLogMessageMobile(logmessage, stringparam, intparam, loginData, callback, asyncState);
    }
    
    private object[] OnEndAddLogMessageMobile(System.IAsyncResult result)
    {
        ((IOMGITService)(this)).EndAddLogMessageMobile(result);
        return null;
    }
    
    private void OnAddLogMessageMobileCompleted(object state)
    {
        if ((this.AddLogMessageMobileCompleted != null))
        {
            InvokeAsyncCompletedEventArgs e = ((InvokeAsyncCompletedEventArgs)(state));
            this.AddLogMessageMobileCompleted(this, new System.ComponentModel.AsyncCompletedEventArgs(e.Error, e.Cancelled, e.UserState));
        }
    }
    
    public void AddLogMessageMobileAsync(string logmessage, string stringparam, int intparam, OMGITWebServices.OMGLoginData loginData)
    {
        this.AddLogMessageMobileAsync(logmessage, stringparam, intparam, loginData, null);
    }
    
    public void AddLogMessageMobileAsync(string logmessage, string stringparam, int intparam, OMGITWebServices.OMGLoginData loginData, object userState)
    {
        if ((this.onBeginAddLogMessageMobileDelegate == null))
        {
            this.onBeginAddLogMessageMobileDelegate = new BeginOperationDelegate(this.OnBeginAddLogMessageMobile);
        }
        if ((this.onEndAddLogMessageMobileDelegate == null))
        {
            this.onEndAddLogMessageMobileDelegate = new EndOperationDelegate(this.OnEndAddLogMessageMobile);
        }
        if ((this.onAddLogMessageMobileCompletedDelegate == null))
        {
            this.onAddLogMessageMobileCompletedDelegate = new System.Threading.SendOrPostCallback(this.OnAddLogMessageMobileCompleted);
        }
        base.InvokeAsync(this.onBeginAddLogMessageMobileDelegate, new object[] {
                    logmessage,
                    stringparam,
                    intparam,
                    loginData}, this.onEndAddLogMessageMobileDelegate, this.onAddLogMessageMobileCompletedDelegate, userState);
    }
    ...
    private class OMGITServiceClientChannel : ChannelBase<IOMGITService>, IOMGITService
    {
        ...
        public System.IAsyncResult BeginRegisterForNotifications(OMGITWebServices.OMGInstallationData name, OMGITWebServices.OMGLoginData loginData, System.AsyncCallback callback, object asyncState)
        {
        ...
        public System.IAsyncResult BeginAddLogMessageMobile(string logmessage, string stringparam, int intparam, OMGITWebServices.OMGLoginData loginData, System.AsyncCallback callback, object asyncState)
        {
            ...
            _args[2] = intparam;
            _args[3] = loginData;
            System.IAsyncResult _result = base.BeginInvoke("AddLogMessageMobile", _args, callback, asyncState);
            return _result;
        }
        
        public void EndAddLogMessageMobile(System.IAsyncResult result)
        {
            object[] _args = new object[0];
            base.EndInvoke("AddLogMessageMobile", _args, result);
        }
