...
namespace OMGTickerMobileAppV2
{
    public partial class TickerDisplayPage : ContentPage
    {
        ...
        Frame notificationFrame = new Frame { Padding = 3, BackgroundColor = Color.FromHex("14986D"), OutlineColor = Color.FromHex("14986D") };

        ScrollView tickerView = new ScrollView { BackgroundColor = Color.Black };

        StackLayout tickerLayout = new StackLayout { HorizontalOptions = LayoutOptions.Center, VerticalOptions = LayoutOptions.Start, BackgroundColor = Color.Black };
        ...
        public TickerDisplayPage()
        {
            ...
            if (Helpers.Settings.UserName != string.Empty)
            {
                ...
                Notifications.Text = "Hello " + Helpers.Settings.UserName + ". There are currently no messages for you";
            }
