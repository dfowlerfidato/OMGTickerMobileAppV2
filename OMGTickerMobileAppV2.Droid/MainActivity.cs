...
{
    [Activity(Label = "OMGNotificationApp", Icon = "@drawable/icon", MainLauncher = true, ConfigurationChanges = ConfigChanges.ScreenSize | ConfigChanges.Orientation)]
    public class MainActivity : global::Xamarin.Forms.Platform.Android.FormsApplicationActivity
    {
        protected override void OnCreate(Bundle bundle)
        {
            ...
            _client.AddLogMessageMobileAsync("Reached OnCreate in mainactivity.cs for Android.", string.Empty,0,GlobalData.loginData);
